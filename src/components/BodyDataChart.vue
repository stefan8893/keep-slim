...
const updateChart = () => {
  ...
  chart.value?.series.at(0)!.setData([...weightSeries.value], false);
  chart.value?.series.at(0)!.update({ type: 'line', name: t(MessageKey.weight) }, false);
  chart.value?.series.at(1)!.setData([...muscleMassSeries.value], false);
  chart.value?.series.at(1)!.update({ type: 'line', name: t(MessageKey.muscleMass) }, false);
  chart.value?.series.at(2)!.setData([...bodyFatSeries.value], false);
  chart.value?.series.at(2)!.update({ type: 'line', name: t(MessageKey.bodyFat) }, false);
  chart.value?.series.at(3)!.setData([...waterSeries.value], false);
  chart.value?.series.at(3)!.update({ type: 'line', name: t(MessageKey.water) }, false);
